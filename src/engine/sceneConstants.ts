...
// focusCluster frames the cluster center; offset = (cluster.radius * scale + base) per axis.
export const FOCUS_CLUSTER_OFFSET_X_SCALE = 0.45;
export const FOCUS_CLUSTER_OFFSET_Y_SCALE = 0.24;
export const FOCUS_CLUSTER_OFFSET_Z_SCALE = 2.4;
